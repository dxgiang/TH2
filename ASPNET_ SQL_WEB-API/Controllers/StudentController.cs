using ASPNET__SQL_WEB_API.Models;
using System;
...
namespace ASPNET__SQL_WEB_API.Controllers
{
    ...
    public class StudentController : ApiController
    {
        ...
        {
            _conn = new SqlConnection("Data Source=OGA;Initial Catalog=Nawab;Integrated Security=True");
